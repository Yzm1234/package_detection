...
class BoxDataset(utils.Dataset):
    ...
    def load_box(self, dataset_dir, subset):
        ...
        self.add_class("box", 1, "Chang")
        self.add_class("box", 2, "Blend")
        self.add_class("box", 3, "Yellow")
        self.add_class("box", 4, "White")
        ...
        print(os.path.abspath("annotations"))
...
def detect_and_color_splash(model, image_path=None, video_path=None):
    ...
    if image_path:
        ...
        visualize.display_instances(image, bbox, mask, class_ids, BoxDataset.class_names)
